...
private:
  ...
  edm::EDGetTokenT<edmNew::DetSetVector<TotemT2RecHit> > rechitsToken_;
};

TotemT2Validator::TotemT2Validator(const edm::ParameterSet& iConfig)
    : rechitsToken_(consumes<edmNew::DetSetVector<TotemT2RecHit> >(iConfig.getParameter<edm::InputTag>("rechitsTag"))) {
}
