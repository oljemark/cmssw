...
const char* FINISHED_PATH = "data/369591.0-200/103,104,105,123,124,125/ev=1E4,pl=3,units=2,ovlp=f,3rpsInO=t/s+sr,std,1rotzIt=0,eMuMvRot=t/finished";
const char* DATA_PATH = "data/369591.0-200/103,104,105,123,124,125/ev=1E4,pl=3,units=2,ovlp=f,3rpsInO=t/s+sr,std,1rotzIt=0,eMuMvRot=t/";
...
int getRomanPotNumber(unsigned long detectorId) {
    ...
    std::map<unsigned long, int> detectorToRomanPot = {
        {1998585856, 104}, {1998618624, 104}, {1998651392, 104}, {1998684160, 104},
        {1998716928, 104}, {1998749696, 104}, {1998782464, 104}, {1998815232, 104},
        {1998848000, 104}, {1998880768, 104},
        {1999110144, 105}, {1999142912, 105}, {1999175680, 105}, {1999208448, 105},
        {1999241216, 105}, {1999273984, 105}, {1999306752, 105}, {1999339520, 105},
        {1999372288, 105}, {1999405056, 105},
        {2006974464, 124}, {2007007232, 124}, {2007040000, 124}, {2007072768, 124},
        {2007105536, 124}, {2007138304, 124}, {2007171072, 124}, {2007203840, 124},
        {2007236608, 124}, {2007269376, 124},
        {2007498752, 125}, {2007531520, 125}, {2007564288, 125}, {2007597056, 125},
        {2007629824, 125}, {2007662592, 125}, {2007695360, 125}, {2007728128, 125},
        {2007760896, 125}, {2007793664, 125},
        {2031616000, 103}, {2031681536, 103}, {2031747072, 103}, {2031812608, 103},
        {2031878144, 103}, {2031943680, 103},
        {2040004608, 123}, {2040070144, 123}, {2040135680, 123}, {2040201216, 123},
        {2040266752, 123}, {2040332288, 123}
    };
...
XMLNodePointer_t AccessXMLSection(TXMLEngine* xml, const char* inputFile, const char* sectionName, XMLDocPointer_t* xmldoc){
...
int GetShiftData(const char* inputFile, std::map<int, float> &ShiftsX, std::map<int, float> &ShiftsY, std::map<int, float> &RotsZ){
    TXMLEngine* xml = new TXMLEngine;
    XMLDocPointer_t xmldocInstance;
    XMLDocPointer_t* xmldoc = &xmldocInstance;
