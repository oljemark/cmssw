...
process.ctppsRPAlignmentCorrectionsDataESSourceXML.RealFiles = cms.vstring('data/369585.0-40/3,4,5,23,24,25-excl1981939712,2023358464,2023489536/ev=4E5,pl=3,units=2,ovlp=f,3rpsInO=t/s+sr,std,1rotzIt=0,eMuMvRot=t/iteration1/results_cumulative_factored_Jan.xml')
...
results_dir="/afs/cern.ch/user/f/foljemar/tmptst/j2/CMSSW_13_0_7_TOTEM/src/CalibPPS/AlignmentRelative/test/test_with_data/data/369585.0-40/3,4,5,23,24,25-excl1981939712,2023358464,2023489536/ev=4E5,pl=3,units=2,ovlp=f,3rpsInO=t/s+sr,std,1rotzIt=0,eMuMvRot=t/iteration2"
