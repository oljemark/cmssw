...
process.ctppsRPAlignmentCorrectionsDataESSourceXML.RealFiles = cms.vstring('data/369585.0-40/3,4,5,23,24,25-excl1981939712,2015166464,2023358464,2023489536/ev=4E5,pl=3,units=2,ovlp=f,3rpsInO=t/s+sr,std,1rotzIt=0,eMuMvRot=t/iteration4/results_cumulative_factored_Jan.xml')
...
process.ppsStraightTrackAligner.excludePlanes = cms.vuint32(1981939712,2015166464,2023358464,2023489536)
process.ppsStraightTrackAligner.z0 = -217000
process.ppsStraightTrackAligner.horizontalOffsets = cms.vstring('3:-3.277', '23:-3.221')
...
results_dir="/afs/cern.ch/user/f/foljemar/tmptst/j2/CMSSW_13_0_7_TOTEM/src/CalibPPS/AlignmentRelative/test/test_with_data/data/369585.0-40/3,4,5,23,24,25-excl1981939712,2015166464,2023358464,2023489536/ev=4E5,pl=3,units=2,ovlp=f,3rpsInO=t/s+sr,std,1rotzIt=0,eMuMvRot=t/iteration5"
