...
process.source = cms.Source("PoolSource",
    ...
    lumisToProcess = cms.untracked.VLuminosityBlockRange("369596:81-369596:120"),
...
process.ctppsRPAlignmentCorrectionsDataESSourceXML.RealFiles = cms.vstring('data/369596.81-120/3,4,5,23,24,25-excl1981939712,2015166464,2023358464,2023489536,1990197248,1990230016,1990262784,1990295552/ev=4E5,pl=3,units=2,ovlp=f,3rpsInO=t/s+sr,std,1rotzIt=0,eMuMvRot=t/iteration4/results_cumulative_factored_Jan.xml')
...
process.ppsStraightTrackAligner.excludePlanes = cms.vuint32(1981939712,2015166464,2023358464,2023489536,1990197248,1990230016,1990262784,1990295552)
process.ppsStraightTrackAligner.z0 = -217000
process.ppsStraightTrackAligner.horizontalOffsets = cms.vstring('3:-3.177', '23:-3.221')

process.ppsStraightTrackAligner.maxResidualToSigma = 3
...
process.ppsStraightTrackAligner.chiSqPerNdfCut = 5
...
results_dir="/afs/cern.ch/user/f/foljemar/tmptst/j2/CMSSW_13_0_7_TOTEM/src/CalibPPS/AlignmentRelative/test/test_with_data/data/369596.81-120/3,4,5,23,24,25-excl1981939712,2015166464,2023358464,2023489536,1990197248,1990230016,1990262784,1990295552/ev=4E5,pl=3,units=2,ovlp=f,3rpsInO=t/s+sr,std,1rotzIt=0,eMuMvRot=t/iteration5"
