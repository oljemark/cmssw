...
process.ctppsRPAlignmentCorrectionsDataESSourceXML.RealFiles = cms.vstring('data/369596.0-40/3,4,5,23,24,25-excl1981939712,2015166464,2023358464,2023489536,1990197248,1990230016,1990262784,1990295552/ev=4E5,pl=3,units=2,ovlp=f,3rpsInO=t/s+sr,std,1rotzIt=0,eMuMvRot=t/iteration4/results_cumulative_factored_Jan.xml')
...
process.ppsStraightTrackAligner.horizontalOffsets = cms.vstring('3:-6.782', '23:-6.412')
